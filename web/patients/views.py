...
class MakePrediction(View):
    ...
    def post(self,req):
        ...
        try:
            ...
            if model == "multiclass":
                prediction_url="http://host.docker.internal:7000/predict"
            else :
                prediction_url="http://host.docker.internal:7000/predict-pneumonia"

            files = {'file': image}

            getdata = requests.post(prediction_url, files=files)
            res["status"]=200
